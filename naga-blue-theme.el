...
(defmacro create-theme-colors ()
  ...
  '(mapcar
    ...
    `((default (:foreground ,fg :background ,bg))
      ...
      (font-lock-warning-face (:slant italic :foreground ,red))
      (fringe (:background ,bg))
      (warning (:foreground ,red :weight regular))
      ...
      (mode-line-emphasis (:fg ,string :weight bold))
      ...
      (show-paren-match (:background ,comment-dark))
      (show-paren-mismatch (:background ,comment-dark))
      (completions-common-part (:inherit 'orderless-match-face-0))
      (error (:foreground ,keyword-blue-red))
      ...
      (erc-current-nick-face (:foreground ,"#00ff00" :weight bold))
      ...
      (eros-result-overlay-face (:foreground ,org-block))
      (geiser-font-lock-repl-output (:foreground ,sea-green))
      (persp-selected-face (:foreground ,keyword-blue-red :weight bold))
      (embark-keybinding (:foreground ,keyword-blue :weight bold))
